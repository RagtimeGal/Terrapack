...
data modify storage spin:storage root.temp.item set from entity @s Inventory[{Slot:103b}]

# Sets the item's data in storage
function spin:item/durability/modify/main
execute unless data storage spin:storage root.temp.item run item replace entity @s armor.head with air
item modify entity @s armor.head spin:durability_lore
data modify storage spin:storage root.temp.item set from entity @s Inventory[{Slot:103b}]
...
item modify entity @s armor.head spin:copy_nbt
